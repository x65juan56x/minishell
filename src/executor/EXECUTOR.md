...
1. Modularidad:
•Cada tipo de nodo tiene su función especializada
•Fácil testing individual de componentes
•Reutilización de código entre diferentes tipos

2. Recursión Natural:
•La estructura del AST se mapea directamente a la ejecución
•Combinaciones complejas se manejan automáticamente
•Sin límite artificial en la profundidad de anidamiento

3. Robustez:
•Manejo consistente de errores en cada nivel
•Cleanup automático de file descriptors
•Exit status correctos propagados hacia arriba

4. Extensibilidad:
•Fácil añadir nuevos tipos de nodos (bonus: &&, ||)
•Sin cambios en la estructura general
•Mantiene compatibilidad hacia atrás

5. Eficiencia:
•Una sola pasada sobre el AST
•Creación mínima de procesos
•File descriptors manejados óptimamente

6. Correctitud:
•Comportamiento idéntico a bash
•Exit status estándar
•Manejo correcto de pipes y redirects
